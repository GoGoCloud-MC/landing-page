	...
	return (
		<footer className="bg-gogo-white dark:bg-gogo-dark-100 border-t border-gogo-grey-90 dark:border-gogo-black-70">
			<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-2 md:grid-cols-4 gap-8">
					...
					<div>
						...
						<ul className="space-y-3">
							...
							<li><a href="#"
								   className="text-sm text-gogo-bluedeep dark:text-gogo-grey-90 hover:text-gogo-blue">Pricing</a>
							</li>
							<li><a href="#"
				...
				<div className="mt-8 pt-8 border-t border-gogo-grey-90 dark:border-gogo-black-70">
